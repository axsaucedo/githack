...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Commit', fields ['user']
        db.delete_unique(u'githack_commit', ['user_id'])


        # Changing field 'Commit.user'
        db.alter_column(u'githack_commit', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Commit.user'
        db.alter_column(u'githack_commit', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Commit', fields ['user']
        db.create_unique(u'githack_commit', ['user_id'])
