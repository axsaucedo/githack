...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Badges.textimage'
        db.add_column(u'githack_badges', 'textimage',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Commit.user'
        db.alter_column(u'githack_commit', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=2, to=orm['auth.User'], unique=True))
        # Deleting field 'Badges.textimage'
        db.delete_column(u'githack_badges', 'textimage')
